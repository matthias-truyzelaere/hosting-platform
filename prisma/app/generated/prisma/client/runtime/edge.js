...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    oi = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function') for (let i of Ea(t)) !xa.call(e, i) && i !== r && ar(e, i, { get: () => t[i], enumerable: !(n = wa(t, i)) || n.enumerable })
        return e
    }
        ...
        va = ci((e) => {
            ...
            function g(A) {
                var R,
                    ...
                    ae = B > 0 ? M - 4 : M,
                    G
                for (G = 0; G < ae; G += 4) (R = (r[A.charCodeAt(G)] << 18) | (r[A.charCodeAt(G + 1)] << 12) | (r[A.charCodeAt(G + 2)] << 6) | r[A.charCodeAt(G + 3)]), (k[F++] = (R >> 16) & 255), (k[F++] = (R >> 8) & 255), (k[F++] = R & 255)
...
var kn = Fe((_y, vo) => {
    ...
    vo.exports = (function () {
        ...
        return function (t, r) {
            ...
            for (var ae = F.length - 1; a < o - 3; ) for (D = r.charCodeAt(s + (f = a)), M = r.charCodeAt(s + (g = a + 1)), B = r.charCodeAt(s + (h = a + 2)), k = r.charCodeAt(s + (v = a + 3)), S = a += 4, l = 0; l < ae; l += 2) (A = F[l]), (R = F[l + 1]), (f = e(A, f, g, D, R)), (g = e(f, g, h, M, R)), (h = e(g, h, v, B, R)), (S = e(h, v, S, k, R)), (F[l] = S), (v = h), (h = g), (g = f), (f = A)
            for (; a < o; ) for (D = r.charCodeAt(s + (f = a)), S = ++a, l = 0; l < ae; l += 2) (A = F[l]), (F[l] = S = e(A, f, S, D, F[l + 1])), (f = A)
            return S
        }
    })()
})
...
C.cosine = C.cos = function () {
    var e,
        ...
        r = this,
        n = r.constructor
    return r.d ? (r.d[0] ? ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = Ml(n, Eo(n, r))), (n.precision = e), (n.rounding = t), I(Te == 2 || Te == 3 ? r.neg() : r, e, t, !0)) : new n(1)) : new n(NaN)
}
C.cubeRoot = C.cbrt = function () {
    ...
    for (_ = !1, o = g.s * J(g.s * g, 1 / 3), !o || Math.abs(o) == 1 / 0 ? ((r = z(g.d)), (e = g.e), (o = (e - r.length + 1) % 3) && (r += o == 1 || o == -2 ? '0' : '00'), (o = J(r, 1 / 3)), (e = X((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2))), o == 1 / 0 ? (r = '5e' + e) : ((r = o.toExponential()), (r = r.slice(0, r.indexOf('e') + 1) + e)), (n = new h(r)), (n.s = g.s)) : (n = new h(o.toString())), s = (e = h.precision) + 3; ; )
...
C.sine = C.sin = function () {
    var e,
        ...
        r = this,
        n = r.constructor
    return r.isFinite() ? (r.isZero() ? new n(r) : ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = Nl(n, Eo(n, r))), (n.precision = e), (n.rounding = t), I(Te > 2 ? r.neg() : r, e, t, !0))) : new n(NaN)
}
C.squareRoot = C.sqrt = function () {
    ...
    for (_ = !1, f = Math.sqrt(+s), f == 0 || f == 1 / 0 ? ((t = z(a)), (t.length + l) % 2 == 0 && (t += '0'), (f = Math.sqrt(t)), (l = X((l + 1) / 2) - (l < 0 || l % 2)), f == 1 / 0 ? (t = '5e' + l) : ((t = f.toExponential()), (t = t.slice(0, t.indexOf('e') + 1) + l)), (n = new g(t))) : (n = new g(f.toString())), r = (l = g.precision) + 3; ; )
...
C.toFraction = function (e) {
    var t,
        ...
        R = S.constructor
    if (!A) return new R(S)
    if (((f = r = new R(1)), (n = l = new R(0)), (t = new R(n)), (o = t.e = go(A) - S.e - 1), (s = o % O), (t.d[0] = J(10, s < 0 ? O + s : s)), e == null)) e = o > 0 ? t : f
    else {
        if (((a = new R(e)), !a.isInt() || a.lt(f))) throw Error(Ie + a)
        e = a.gt(t) ? (o > 0 ? t : f) : a
    }
    for (_ = !1, a = new R(z(A)), g = R.precision, R.precision = o = A.length * O * 2; (h = q(a, t, 0, 1, 1)), (i = r.plus(h.times(n))), i.cmp(e) != 1; ) (r = n), (n = i), (i = f), (f = l.plus(h.times(i))), (l = i), (i = t), (t = a.minus(h.times(i))), (a = i)
    return (
...
C.toPower = C.pow = function (e) {
    ...
    return (
        ...
        t > l.maxE + 1 || t < l.minE - 1 ? new l(t > 0 ? s / 0 : 0) : ((_ = !1), (l.rounding = a.s = 1), (r = Math.min(12, (t + '').length)), (i = An(e.times(ke(a, n + r)), n)), i.d && ((i = I(i, n + 5, 1)), St(i.d, n, o) && ((t = n + 10), (i = I(An(e.times(ke(a, t + r)), t), t + 5, 1)), +z(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))), (i.s = s), (_ = !0), (l.rounding = o), I(i, n, o))
    )
}
...
var q = (function () {
    ...
    return function (n, i, o, s, a, l) {
        ...
        for (l ? ((S = 1), (g = n.e - i.e)) : ((l = ce), (S = O), (g = X(n.e / S) - X(i.e / S))), ue = $.length, xt = Y.length, M = new sr(sn), B = M.d = [], h = 0; $[h] == (Y[h] || 0); h++);
        if (($[h] > (Y[h] || 0) && g--, o == null ? ((G = o = sr.precision), (s = sr.rounding)) : a ? (G = o + (n.e - i.e) + 1) : (G = o), G < 0)) B.push(1), (A = !0)
        else {
            if (((G = (G / S + 2) | 0), (h = 0), ue == 1)) {
                for (v = 0, $ = $[0], G++; (h < xt || v) && G--; h++) (nn = v * l + (Y[h] || 0)), (B[h] = (nn / $) | 0), (v = nn % $ | 0)
                A = v || h < xt
            } else {
                for (v = (l / ($[0] + 1)) | 0, v > 1 && (($ = e($, v, l)), (Y = e(Y, v, l)), (ue = $.length), (xt = Y.length)), ir = ue, k = Y.slice(0, ue), F = k.length; F < ue; ) k[F++] = 0
                ;(or = $.slice()), or.unshift(0), (on = $[0]), $[1] >= l / 2 && ++on
                do
                    (v = 0),
                        (f = t($, k, ue, F)),
                        f < 0 ? ((ae = k[0]), ue != F && (ae = ae * l + (k[1] || 0)), (v = (ae / on) | 0), v > 1 ? (v >= l && (v = l - 1), (R = e($, v, l)), (D = R.length), (F = k.length), (f = t(R, k, D, F)), f == 1 && (v--, r(R, ue < D ? or : $, D, l))) : (v == 0 && (f = v = 1), (R = $.slice())), (D = R.length), D < F && R.unshift(0), r(k, R, F, l), f == -1 && ((F = k.length), (f = t($, k, ue, F)), f < 1 && (v++, r(k, ue < F ? or : $, F, l))), (F = k.length)) : f === 0 && (v++, (k = [0])),
                        (B[h++] = v),
...
function ke(e, t) {
    ...
    } else return (f = Er(M, g + 2, k).times(o + '')), (R = ke(new M(n + '.' + r.slice(1)), g - A).plus(f)), (M.precision = k), t == null ? I(R, k, B, (_ = !0)) : R
    for (h = R, l = s = R = q(R.minus(1), R.plus(1), g, 1), v = I(R.times(R), g, 1), i = 3; ; ) {
        if (((s = I(s.times(v), g, 1)), (f = l.plus(q(s, new M(i), g, 1))), z(f.d).slice(0, g) === z(l.d).slice(0, g)))
            if (((l = l.times(2)), o !== 0 && (l = l.plus(Er(M, g + 2, k).times(o + ''))), (l = q(l, new M(S), g, 1)), t == null))
                if (St(l.d, g - A, B, a)) (M.precision = g += A), (f = s = R = q(h.minus(1), h.plus(1), g, 1)), (v = I(R.times(R), g, 1)), (i = a = 1)
...
function _l(e, t) {
    ...
    for (o = t.search(/p/i), o > 0 ? ((l = +t.slice(o + 1)), (t = t.substring(2, o))) : (t = t.slice(2)), o = t.indexOf('.'), s = o >= 0, n = e.constructor, s && ((t = t.replace('.', '')), (a = t.length), (o = a - o), (i = ho(n, new n(r), o, o * 2))), f = gr(t, r, ce), g = f.length - 1, o = g; f[o] === 0; --o) f.pop()
...
function Rn(e, t, r, n) {
    ...
    if ((A ? (ie(r, 1, Oe), n === void 0 ? (n = S.rounding) : ie(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite())) g = wo(e)
        ...
        for (g = ge(e), s = g.indexOf('.'), A ? ((i = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (i = t), s >= 0 && ((g = g.replace('.', '')), (v = new S(1)), (v.e = g.length - s), (v.d = gr(ge(v), 10, i)), (v.e = v.d.length)), h = gr(g, 10, i), o = l = h.length; h[--l] == 0; ) h.pop()
        if (!h[0]) g = A ? '0p+0' : '0'
        else {
...
function bo(e) {
    ...
    function i(o) {
        ...
        if (l === 'string') return (a = o.charCodeAt(0)) === 45 ? ((o = o.slice(1)), (f.s = -1)) : (a === 43 && (o = o.slice(1)), (f.s = 1)), fo.test(o) ? hr(f, o) : _l(f, o)
...
function $o(e, t, r) {
    let n = Ee(r)
    return !t.result || !(t.result.$allModels || t.result[n]) ? e : tc({ ...e, ...qo(t.name, e, t.result.$allModels), ...qo(t.name, e, t.result[n]) })
}
function tc(e) {
    let t = new ye(),
...
function Br({ modelName: e, action: t, args: r, runtimeDataModel: n, extensions: i = ct.empty(), callsite: o, clientMethod: s, errorFormat: a, clientVersion: l, previewFeatures: f, globalOmit: g }) {
...
function ic(e, t, r, n) {
    return e ? (t ? n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'include', secondField: 'select', selectionPath: n.getSelectionPath() }) : r && n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'omit', secondField: 'select', selectionPath: n.getSelectionPath() }), lc(e, n)) : oc(n, t, r)
}
function oc(e, t, r) {
    let n = {}
...
function Qr({ error: e, user_facing_error: t }, r, n) {
    return t.error_code ? new re(hc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx }) : new ne(e, { clientVersion: r, batchRequestIdx: t.batch_request_idx })
}
function hc(e, t) {
    let r = e.message
    return (
...
function Qt(e) {
    ...
    if (typeof e == 'object') {
        let t = {}
        for (let r in e) r === '__proto__' ? Object.defineProperty(t, r, { value: Qt(e[r]), configurable: !0, enumerable: !0, writable: !0 }) : (t[r] = Qt(e[r]))
        return t
    }
    Pe(e, 'Unknown value')
}
...
var Bs = 3,
    ...
    wt = class {
        ...
        async start() {
            this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ;(this.host = t), (this.headerBuilder = new Zn({ apiKey: r, tracingHelper: this.tracingHelper, logLevel: this.config.logLevel, logQueries: this.config.logQueries, engineHash: this.engineHash })), (this.remoteClientVersion = await Ls(t, this.config)), zr('host', this.host)
                })()),
        ...
        extractHostAndApiKey() {
            ...
            if (o !== 'prisma:' && o !== fr) throw new qe(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\``, t)
            let l = a.get('api_key')
            ...
            ;(this.logEmitter = r),
                ...
                (this.dataloader = new en({
                    batchLoader: Cs(async ({ requests: n, customDataProxyFetch: i }) => {
                        ...
                        return (await this.client._engine.requestBatch(a, { traceparent: l, transaction: ap(o), containsWrite: f, customDataProxyFetch: i })).map((h, v) => {
                    ...
                    singleLoader: async (n) => {
                        let i = n.transaction?.kind === 'itx' ? ta(n.transaction) : void 0,
                            o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: ii(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch })
...
It should have this form: { url: "CONNECTION_STRING" }`)
        ...
        adapter: (e, t) => {
            ...
            if (!Yr(t).includes('driverAdapters')) throw new U('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.')
...
function fa(e) {
    class t {
        ...
        constructor(n) {
            ...
            let o = e.relativeEnvPaths && { rootEnvPath: e.relativeEnvPaths.rootEnvPath && dr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && dr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
                s
            if (n?.adapter) {
                s = n.adapter
            ...
            try {
                ...
                if (
                    ...
                    (this._accelerateEngineConfig = { ...this._engineConfig, accelerateUtils: { resolveDatasourceUrl: ft, getBatchRequestPayload: Gr, prismaGraphQLToJSError: Qr, PrismaClientUnknownRequestError: ne, PrismaClientInitializationError: Q, PrismaClientKnownRequestError: re, debug: K('prisma:client:accelerateEngine'), engineVersion: da.version, clientVersion: e.clientVersion } }),
        ...
        $executeRawInternal(n, i, o, s) {
            ...
            return this._request({ action: 'executeRaw', args: o, transaction: n, clientMethod: i, argsMapper: ei({ clientMethod: i, activeProvider: a }), callsite: _e(this._errorFormat), dataPath: [], middlewareArgsMapper: s })
        }
        $executeRaw(n, ...i) {
        ...
        $runCommandRaw(n) {
            ...
            return this._createPrismaPromise((i) => this._request({ args: n, clientMethod: '$runCommandRaw', dataPath: [], action: 'runCommandRaw', argsMapper: qs, callsite: _e(this._errorFormat), transaction: i }))
        }
        async $queryRawInternal(n, i, o, s) {
            let a = this._activeProvider
            return this._request({ action: 'queryRaw', args: o, transaction: n, clientMethod: i, argsMapper: ei({ clientMethod: i, activeProvider: a }), callsite: _e(this._errorFormat), dataPath: [], middlewareArgsMapper: s })
        }
        $queryRaw(n, ...i) {
            return this._createPrismaPromise((o) => {
        ...
        _createItxClient(n) {
            return pe(Gt(pe(gs(this), [ee('_appliedParent', () => this._appliedParent._createItxClient(n)), ee('_createPrismaPromise', () => ti(n)), ee(hp, () => n.id)])), [mt(bs)])
        }
        $transaction(n, i) {
            let o
            typeof n == 'function'
        ...
        async _executeRequest({ args: n, clientMethod: i, dataPath: o, callsite: s, action: a, model: l, argsMapper: f, transaction: g, unpacker: h, otelParentCtx: v, customDataProxyFetch: S }) {
            try {
                ...
                let A = { name: 'serialize' },
                    R = this._tracingHelper.runInChildSpan(A, () => Br({ modelName: l, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }))
                return (
