...
h.cubeRoot = h.cbrt = function () {
    ...
    for (w = !1, s = l.s * C(l.s * l, 1 / 3), !s || Math.abs(s) == 1 / 0 ? ((i = b(l.d)), (e = l.e), (s = (e - i.length + 1) % 3) && (i += s == 1 || s == -2 ? '0' : '00'), (s = C(i, 1 / 3)), (e = R((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2))), s == 1 / 0 ? (i = '5e' + e) : ((i = s.toExponential()), (i = i.slice(0, i.indexOf('e') + 1) + e)), (t = new a(i)), (t.s = l.s)) : (t = new a(s.toString())), o = (e = a.precision) + 3; ; )
...
h.inverseHyperbolicTangent = h.atanh = function () {
    var e,
        ...
        r = this,
        s = r.constructor
    return r.isFinite() ? (r.e >= 0 ? new s(r.abs().eq(1) ? r.s / 0 : r.isZero() ? r : NaN) : ((e = s.precision), (n = s.rounding), (t = r.sd()), Math.max(t, e) < 2 * -r.e - 1 ? p(new s(r), e, n, !0) : ((s.precision = i = t - r.e), (r = k(r.plus(1), new s(1).minus(r), i + e, 1)), (s.precision = e + 4), (s.rounding = 1), (r = r.ln()), (s.precision = e), (s.rounding = n), r.times(0.5)))) : new s(NaN)
}
...
h.squareRoot = h.sqrt = function () {
    ...
    for (w = !1, f = Math.sqrt(+o), f == 0 || f == 1 / 0 ? ((n = b(u)), (n.length + c) % 2 == 0 && (n += '0'), (f = Math.sqrt(n)), (c = R((c + 1) / 2) - (c < 0 || c % 2)), f == 1 / 0 ? (n = '5e' + c) : ((n = f.toExponential()), (n = n.slice(0, n.indexOf('e') + 1) + c)), (t = new l(n))) : (t = new l(f.toString())), i = (c = l.precision) + 3; ; )
...
h.toPower = h.pow = function (e) {
    ...
    return (
        ...
        n > c.maxE + 1 || n < c.minE - 1 ? new c(n > 0 ? o / 0 : 0) : ((w = !1), (c.rounding = u.s = 1), (i = Math.min(12, (n + '').length)), (r = Se(e.times(B(u, t + i)), t)), r.d && ((r = p(r, t + 5, 1)), Q(r.d, t, s) && ((n = t + 10), (r = p(Se(e.times(B(u, n + i)), n), n + 5, 1)), +b(r.d).slice(t + 1, t + 15) + 1 == 1e14 && (r = p(r, t + 1, 0)))), (r.s = o), (w = !0), (c.rounding = s), p(r, t, s))
    )
}
        ...
        if ((S[a] > (O[a] || 0) && l--, s == null ? ((I = s = ee.precision), (o = ee.rounding)) : u ? (I = s + (t.e - r.e) + 1) : (I = s), I < 0)) _.push(1), (v = !0)
            ...
            if (((I = (I / g + 2) | 0), (a = 0), T == 1)) {
                ...
                do
                    (d = 0),
                        (f = n(S, E, T, P)),
                        f < 0 ? ((x = E[0]), T != P && (x = x * c + (E[1] || 0)), (d = (x / he) | 0), d > 1 ? (d >= c && (d = c - 1), (N = e(S, d, c)), (A = N.length), (P = E.length), (f = n(N, E, A, P)), f == 1 && (d--, i(N, T < A ? y : S, A, c))) : (d == 0 && (f = d = 1), (N = S.slice())), (A = N.length), A < P && N.unshift(0), i(E, N, P, c), f == -1 && ((P = E.length), (f = n(S, E, T, P)), f < 1 && (d++, i(E, T < P ? y : S, P, c))), (P = E.length)) : f === 0 && (d++, (E = [0])),
                        (_[a++] = d),
...
function Sn(e, n) {
    ...
    var i,
        ...
        s = t + 4
    return (
        !e.s || !n.s ? (i = new this(NaN)) : !e.d && !n.d ? ((i = F(this, s, 1).times(n.s > 0 ? 0.25 : 0.75)), (i.s = e.s)) : !n.d || e.isZero() ? ((i = n.s < 0 ? F(this, t, r) : new this(0)), (i.s = e.s)) : !e.d || n.isZero() ? ((i = F(this, s, 1).times(0.5)), (i.s = e.s)) : n.s < 0 ? ((this.precision = s), (this.rounding = 1), (i = this.atan(k(e, n, s, 1))), (n = F(this, s, 1)), (this.precision = t), (this.rounding = r), (i = e.s < 0 ? i.minus(n) : i.plus(n))) : (i = this.atan(k(e, n, s, 1))),
        i
    )
}
function Mn(e) {
