...
var Cs = ne((Ch, ep) => {
    ep.exports = {
        ...
        main: 'lib/main.js',
        types: 'lib/main.d.ts',
        exports: { '.': { types: './lib/main.d.ts', require: './lib/main.js', default: './lib/main.js' }, './config': './config.js', './config.js': './config.js', './lib/env-options': './lib/env-options.js', './lib/env-options.js': './lib/env-options.js', './lib/cli-options': './lib/cli-options.js', './lib/cli-options.js': './lib/cli-options.js', './package.json': './package.json' },
        scripts: { 'dts-check': 'tsc --project tests/types/tsconfig.json', lint: 'standard', pretest: 'npm run lint && npm run dts-check', test: 'tap run --allow-empty-coverage --disable-coverage --timeout=60000', 'test:coverage': 'tap run --show-full-coverage --timeout=60000 --coverage-report=lcov', prerelease: 'npm test', release: 'standard-version' },
...
var ui = class e {
    ...
    with(...r) {
        ...
        let o = !1,
            ...
            l = !n.some((u) => Ee(u, this.input, a)) || (i && !i(this.input)) ? li : { matched: !0, value: t(o ? (Gt in s ? s[Gt] : s) : this.input, this.input) }
...
m.cubeRoot = m.cbrt = function () {
    ...
    for (w = !1, o = c.s * U(c.s * c, 1 / 3), !o || Math.abs(o) == 1 / 0 ? ((t = J(c.d)), (e = c.e), (o = (e - t.length + 1) % 3) && (t += o == 1 || o == -2 ? '0' : '00'), (o = U(t, 1 / 3)), (e = X((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2))), o == 1 / 0 ? (t = '5e' + e) : ((t = o.toExponential()), (t = t.slice(0, t.indexOf('e') + 1) + e)), (n = new p(t)), (n.s = c.s)) : (n = new p(o.toString())), s = (e = p.precision) + 3; ; )
...
m.inverseHyperbolicTangent = m.atanh = function () {
    var e,
        ...
        i = this,
        o = i.constructor
    return i.isFinite() ? (i.e >= 0 ? new o(i.abs().eq(1) ? i.s / 0 : i.isZero() ? i : NaN) : ((e = o.precision), (r = o.rounding), (n = i.sd()), Math.max(n, e) < 2 * -i.e - 1 ? y(new o(i), e, r, !0) : ((o.precision = t = n - i.e), (i = L(i.plus(1), new o(1).minus(i), t + e, 1)), (o.precision = e + 4), (o.rounding = 1), (i = i.ln()), (o.precision = e), (o.rounding = r), i.times(0.5)))) : new o(NaN)
}
...
m.squareRoot = m.sqrt = function () {
    ...
    for (w = !1, u = Math.sqrt(+s), u == 0 || u == 1 / 0 ? ((r = J(a)), (r.length + l) % 2 == 0 && (r += '0'), (u = Math.sqrt(r)), (l = X((l + 1) / 2) - (l < 0 || l % 2)), u == 1 / 0 ? (r = '5e' + l) : ((r = u.toExponential()), (r = r.slice(0, r.indexOf('e') + 1) + l)), (n = new c(r))) : (n = new c(u.toString())), t = (l = c.precision) + 3; ; )
...
m.toPower = m.pow = function (e) {
    ...
    return (
        ...
        r > l.maxE + 1 || r < l.minE - 1 ? new l(r > 0 ? s / 0 : 0) : ((w = !1), (l.rounding = a.s = 1), (t = Math.min(12, (r + '').length)), (i = Bi(e.times(Je(a, n + t)), n)), i.d && ((i = y(i, n + 5, 1)), st(i.d, n, o) && ((r = n + 10), (i = y(Bi(e.times(Je(a, r + t)), r), r + 5, 1)), +J(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = y(i, n + 1, 0)))), (i.s = s), (w = !0), (l.rounding = o), y(i, n, o))
    )
}
        ...
        if ((_[p] > (K[p] || 0) && c--, o == null ? ((ae = o = $t.precision), (s = $t.rounding)) : a ? (ae = o + (n.e - i.e) + 1) : (ae = o), ae < 0)) S.push(1), (g = !0)
            ...
            if (((ae = (ae / f + 2) | 0), (p = 0), H == 1)) {
                ...
                do
                    (d = 0),
                        (u = r(_, b, H, O)),
                        u < 0 ? ((me = b[0]), H != O && (me = me * l + (b[1] || 0)), (d = (me / Ae) | 0), d > 1 ? (d >= l && (d = l - 1), (h = e(_, d, l)), (I = h.length), (O = b.length), (u = r(h, b, I, O)), u == 1 && (d--, t(h, H < I ? fr : _, I, l))) : (d == 0 && (u = d = 1), (h = _.slice())), (I = h.length), I < O && h.unshift(0), t(b, h, O, l), u == -1 && ((O = b.length), (u = r(_, b, H, O)), u < 1 && (d++, t(b, H < O ? fr : _, O, l))), (O = b.length)) : u === 0 && (d++, (b = [0])),
                        (S[p++] = d),
    ...
    for (p = h, l = s = h = L(h.minus(1), h.plus(1), c, 1), d = y(h.times(h), c, 1), i = 3; ; ) {
        if (((s = y(s.times(d), c, 1)), (u = l.plus(L(s, new P(i), c, 1))), J(u.d).slice(0, c) === J(l.d).slice(0, c)))
            if (((l = l.times(2)), o !== 0 && (l = l.plus(pn(P, c + 2, b).times(o + ''))), (l = L(l, new P(f), c, 1)), r == null))
                if (st(l.d, c - g, S, a)) (P.precision = c += g), (u = s = h = L(p.minus(1), p.plus(1), c, 1)), (d = y(h.times(h), c, 1)), (i = a = 1)
            ...
            : !e.d && !r.d
              ...
              : !r.d || e.isZero()
                ...
                : !e.d || r.isZero()
                  ...
                  : r.s < 0
                    ? ((this.precision = o), (this.rounding = 1), (t = this.atan(L(e, r, o, 1))), (r = we(this, o, 1)), (this.precision = n), (this.rounding = i), (t = e.s < 0 ? t.minus(r) : t.plus(r)))
...
function Ya(e) {
    ...
    let r = Object.create(this._originalClient, { _extensions: { value: this._extensions.append(e) }, _appliedParent: { value: this, configurable: !0 }, $use: { value: void 0 }, $on: { value: void 0 } })
    return vt(r)
}
...
function Pt(e) {
    ...
    if (typeof e == 'object') {
        let r = {}
        for (let t in e) t === '__proto__' ? Object.defineProperty(r, t, { value: Pt(e[t]), configurable: !0, enumerable: !0, writable: !0 }) : (r[t] = Pt(e[t]))
        return r
    }
    _e(e, 'Unknown value')
}
...
async function yl(e, r) {
    ...
    let o = await ir(),
        ...
        c = { searchedLocations: i, generatorBinaryTargets: s, generator: r.generator, runtimeBinaryTarget: o, queryEngineName: bl(e, o), expectedLocation: Tt.default.relative(process.cwd(), r.dirname), errorStack: new Error().stack },
        p
    ...
    Mt = class {
        ...
        extractHostAndApiKey() {
            let r = { clientVersion: this.clientVersion },
                ...
                n = jr({ inlineDatasources: this.inlineDatasources, overrideDatasources: this.config.overrideDatasources, clientVersion: this.clientVersion, env: this.env }),
                i
            try {
                i = new URL(n)
            } catch {
...
var wo = (e, r = new Eo()) => {
    ...
    pf = (e, r) => ({ adapterName: r.adapterName, provider: r.provider, options: r.options, queryRaw: $e(e, r.queryRaw.bind(r)), executeRaw: $e(e, r.executeRaw.bind(r)), commit: $e(e, r.commit.bind(r)), rollback: $e(e, r.rollback.bind(r)) })
function $e(e, r) {
    return async (...t) => {
        try {
            return Qn(await r(...t))
                ...
                t && Ce('Using driver adapter: %O', t),
                    (this.engine = this.wrapEngine(
                        new this.QueryEngineConstructor(
                            { datamodel: this.datamodel, env: process.env, logQueries: this.config.logQueries ?? !1, ignoreEnvVarErrors: !0, datasourceOverrides: this.datasourceOverrides ?? {}, logLevel: this.logLevel, configDir: this.config.cwd, engineProtocol: 'json', enableTracing: this.tracingHelper.isEnabled() },
                            (n) => {
                                r.deref()?.logger(n)
                            },
                            t
                ...
                (this.dataloader = new Kn({
                    ...
                    singleLoader: async (n) => {
                        let i = n.transaction?.kind === 'itx' ? Xl(n.transaction) : void 0,
                            o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Oo(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch })
...
function gu(e) {
    class r {
        ...
        constructor(n) {
            ...
            let o = e.relativeEnvPaths && { rootEnvPath: e.relativeEnvPaths.rootEnvPath && Zn.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && Zn.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
                s
            if (n?.adapter) {
                s = n.adapter
            ...
            try {
                ...
                if (
                    ...
                    (this._accelerateEngineConfig = { ...this._engineConfig, accelerateUtils: { resolveDatasourceUrl: jr, getBatchRequestPayload: Mr, prismaGraphQLToJSError: $r, PrismaClientUnknownRequestError: j, PrismaClientInitializationError: T, PrismaClientKnownRequestError: z, debug: N('prisma:client:accelerateEngine'), engineVersion: pu.version, clientVersion: e.clientVersion } }),
        ...
        async _executeRequest({ args: n, clientMethod: i, dataPath: o, callsite: s, action: a, model: l, argsMapper: u, transaction: c, unpacker: p, otelParentCtx: d, customDataProxyFetch: f }) {
            try {
                ...
                let g = { name: 'serialize' },
                    h = this._tracingHelper.runInChildSpan(g, () => Dn({ modelName: l, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }))
                return (
...
`
                    ...
                    this._requestHandler.request({ protocolQuery: h, modelName: l, action: a, clientMethod: i, dataPath: o, callsite: s, args: n, extensions: this._extensions, transaction: c, unpacker: p, otelParentCtx: d, otelChildCtx: this._tracingHelper.getActiveContext(), globalOmit: this._globalOmit, customDataProxyFetch: f })
                )
            } catch (g) {
