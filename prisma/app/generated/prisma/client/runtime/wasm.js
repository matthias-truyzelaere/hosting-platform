    ...
    u = ne(() => {
        ...
        y = class t extends Uint8Array {
            ...
            write(e, r, n, i = 'utf8') {
                ...
                return (i = typeof r == 'string' ? r : typeof n == 'string' ? n : i), B(o, 'offset'), B(s, 'length'), V(o, 'offset', this.length), V(s, 'length', this.length), (i === 'ucs2' || i === 'ucs-2' || i === 'utf16le' || i === 'utf-16le') && (s = s - (s % 2)), Er(e, i).copy(this, o, 0, s)
            }
            ...
            toString(e = 'utf8', r = 0, n = this.length) {
                ...
                if (e === 'binary' || e === 'ascii' || e === 'latin1' || e === 'latin-1') return this.slice(r, n).reduce((i, o) => i + xr(o & (e === 'ascii' ? 127 : 255)), '')
                if (e === 'ucs2' || e === 'ucs-2' || e === 'utf16le' || e === 'utf-16le') {
        ...
        ;(os = { int8: [-128, 127], int16: [-32768, 32767], int32: [-2147483648, 2147483647], uint8: [0, 255], uint16: [0, 65535], uint32: [0, 4294967295], float32: [-1 / 0, 1 / 0], float64: [-1 / 0, 1 / 0], bigint64: [-0x8000000000000000n, 0x7fffffffffffffffn], biguint64: [0n, 0xffffffffffffffffn] }),
            (ss = new TextEncoder()),
            (as = new TextDecoder()),
...
function it(t, e) {
    ...
    } else return (f = Pr(S, h + 2, M).times(o + '')), (A = it(new S(n + '.' + r.slice(1)), h - k).plus(f)), (S.precision = M), e == null ? ((q = !0), D(A, M)) : A
    for (a = s = A = he(A.minus(ee), A.plus(ee), h), T = D(A.times(A), h), i = 3; ; ) {
        if (((s = D(s.times(T), h)), (f = a.plus(he(s, new S(i), h))), ue(f.d).slice(0, h) === ue(a.d).slice(0, h))) return (a = a.times(2)), o !== 0 && (a = a.plus(Pr(S, h + 2, M).times(o + ''))), (a = he(a, new S(C), h)), (S.precision = M), e == null ? ((q = !0), D(a, M)) : a
        ;(a = f), (i += 2)
    }
}
function dn(t, e) {
...
function D(t, e, r) {
    ...
    if ((r !== void 0 && ((o = ke(10, s - i - 1)), (a = (h / o) % 10 | 0), (f = e < 0 || C[T + 1] !== void 0 || h % o), (f = r < 4 ? (a || f) && (r == 0 || r == (t.s < 0 ? 3 : 2)) : a > 5 || (a == 5 && (r == 4 || f || (r == 6 && (n > 0 ? (i > 0 ? h / ke(10, s - i) : 0) : C[T - 1]) % 10 & 1) || r == (t.s < 0 ? 8 : 7))))), e < 1 || !C[0]))
        return f ? ((o = $(t)), (C.length = 1), (e = e - o - 1), (C[0] = ke(10, (N - (e % N)) % N)), (t.e = Ne(-e / N) || 0)) : ((C.length = 1), (C[0] = t.e = t.s = 0)), t
    ...
    En = ne(() => {
        ...
        R.toExponential = function (t, e) {
            var r,
                n = this,
                i = n.constructor
            return t === void 0 ? (r = Me(n, !0)) : (ce(t, 0, Fe), e === void 0 ? (e = i.rounding) : ce(e, 0, 8), (n = D(new i(n), t + 1, e)), (r = Me(n, !0, t + 1))), r
        }
        R.toFixed = function (t, e) {
            var r,
                ...
                i = this,
                o = i.constructor
            return t === void 0 ? Me(i) : (ce(t, 0, Fe), e === void 0 ? (e = o.rounding) : ce(e, 0, 8), (n = D(new o(i), t + $(i) + 1, e)), (r = Me(n.abs(), !1, t + $(n) + 1)), i.isneg() && !i.isZero() ? '-' + r : r)
        }
        ...
        R.toPrecision = function (t, e) {
            var r,
                ...
                i = this,
                o = i.constructor
            return t === void 0 ? ((r = $(i)), (n = Me(i, r <= o.toExpNeg || r >= o.toExpPos))) : (ce(t, 1, Fe), e === void 0 ? (e = o.rounding) : ce(e, 0, 8), (i = D(new o(i), t, e)), (r = $(i)), (n = Me(i, t <= r || r <= o.toExpNeg, t))), n
        }
        R.toSignificantDigits = R.tosd = function (t, e) {
            var r = this,
                n = r.constructor
            return t === void 0 ? ((t = n.precision), (e = n.rounding)) : (ce(t, 1, Fe), e === void 0 ? (e = n.rounding) : ce(e, 0, 8)), D(new n(r), t, e)
        }
        R.toString =
            R.valueOf =
            R.val =
        ...
        he = (function () {
            ...
            return function (n, i, o, s) {
                ...
                if (((H = (H / N + 2) | 0), (h = 0), se == 1)) for (T = 0, U = U[0], H++; (h < Se || T) && H--; h++) (L = T * Q + (le[h] || 0)), (O[h] = (L / U) | 0), (T = L % U | 0)
                else {
                    for (T = (Q / (U[0] + 1)) | 0, T > 1 && ((U = t(U, T)), (le = t(le, T)), (se = U.length), (Se = le.length)), z = se, S = le.slice(0, se), M = S.length; M < se; ) S[M++] = 0
                    ;(St = U.slice()), St.unshift(0), (wr = U[0]), U[1] >= Q / 2 && ++wr
                    do
                        (T = 0),
                            (a = e(U, S, se, M)),
                            a < 0 ? ((oe = S[0]), se != M && (oe = oe * Q + (S[1] || 0)), (T = (oe / wr) | 0), T > 1 ? (T >= Q && (T = Q - 1), (C = t(U, T)), (k = C.length), (M = S.length), (a = e(C, S, k, M)), a == 1 && (T--, r(C, se < k ? St : U, k))) : (T == 0 && (a = T = 1), (C = U.slice())), (k = C.length), k < M && C.unshift(0), r(S, C, M), a == -1 && ((M = S.length), (a = e(U, S, se, M)), a < 1 && (T++, r(S, se < M ? St : U, M))), (M = S.length)) : a === 0 && (T++, (S = [0])),
                            (O[h++] = T),
...
function wa(t, e) {
    ...
    e.addErrorMessage((o) => {
        ...
        return (
            t.constraints.minFieldCount === 1 && t.constraints.maxFieldCount == 1 ? s.push(`${o.green('exactly one')} argument,`) : t.constraints.maxFieldCount == 1 ? s.push(`${o.green('at most one')} argument,`) : s.push(`${o.green(`at most ${t.constraints.maxFieldCount}`)} arguments,`),
            s.push(
                `but you provided ${Jt(
                    'and',
                    i.map((a) => o.red(a))
...
function vi(t, e, r) {
    let n = fe(r)
    return !e.result || !(e.result.$allModels || e.result[n]) ? t : Ra({ ...t, ...Pi(e.name, t, e.result.$allModels), ...Pi(e.name, t, e.result[n]) })
}
function Ra(t) {
    let e = new pe(),
...
function ka(t, e, r, n) {
    return t ? (e ? n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'include', secondField: 'select', selectionPath: n.getSelectionPath() }) : r && n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'omit', secondField: 'select', selectionPath: n.getSelectionPath() }), _a(t, n)) : Oa(n, e, r)
}
function Oa(t, e, r) {
    let n = {}
...
function Vr(t, e) {
    t === void 0 && e.isPreviewFeatureOn('strictUndefinedChecks') && e.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: e.getSelectionPath(), underlyingError: ki })
}
var $r = class t {
    constructor(e) {
        this.params = e
...
function Ct(t) {
    ...
    if (typeof t == 'object') {
        let e = {}
        for (let r in t) r === '__proto__' ? Object.defineProperty(e, r, { value: Ct(t[r]), configurable: !0, enumerable: !0, writable: !0 }) : (e[r] = Ct(t[r]))
        return e
    }
    be(t, 'Unknown value')
}
...
var en = (t, e = new Zr()) => {
        let r = { adapterName: t.adapterName, errorRegistry: e, queryRaw: xe(e, t.queryRaw.bind(t)), executeRaw: xe(e, t.executeRaw.bind(t)), executeScript: xe(e, t.executeScript.bind(t)), dispose: xe(e, t.dispose.bind(t)), provider: t.provider, startTransaction: async (...n) => (await xe(e, t.startTransaction.bind(t))(...n)).map((o) => hl(e, o)) }
        return t.getConnectionInfo && (r.getConnectionInfo = bl(e, t.getConnectionInfo.bind(t))), r
    },
    hl = (t, e) => ({ adapterName: e.adapterName, provider: e.provider, options: e.options, queryRaw: xe(t, e.queryRaw.bind(e)), executeRaw: xe(t, e.executeRaw.bind(e)), commit: xe(t, e.commit.bind(e)), rollback: xe(t, e.rollback.bind(e)) })
function xe(t, e) {
    return async (...r) => {
        try {
            return mr(await e(...r))
...
var Rt = class {
    ...
    logger(e) {
        ...
        r && ((r.level = r?.level.toLowerCase() ?? 'unknown'), El(r) ? this.logEmitter.emit('query', { timestamp: new Date(), query: r.query, params: r.params, duration: Number(r.duration_ms), target: r.module_path }) : (xl(r), this.logEmitter.emit(r.level, { timestamp: new Date(), message: r.message, target: r.module_path })))
    }
    parseInitError(e) {
        try {
            return JSON.parse(e)
    ...
    async stop() {
        ...
        let e = async () => {
            ...
            let r = { traceparent: this.tracingHelper.getTraceParent() }
            await this.engine?.disconnect(JSON.stringify(r)), (this.libraryStarted = !1), (this.libraryStoppingPromise = void 0), await (await this.adapterPromise)?.dispose(), (this.adapterPromise = void 0), ye('library stopped')
        }
            ...
            ;(this.logEmitter = r),
                ...
                (this.dataloader = new yr({
                    batchLoader: ao(async ({ requests: n, customDataProxyFetch: i }) => {
                        ...
                        return (await this.client._engine.requestBatch(a, { traceparent: f, transaction: Il(o), containsWrite: h, customDataProxyFetch: i })).map((C, k) => {
...
var qo = ['datasources', 'datasourceUrl', 'errorFormat', 'adapter', 'log', 'transactionOptions', 'omit', '__internal'],
    ...
    Fl = {
        datasources: (t, { datasourceNames: e }) => {
            if (t) {
                if (typeof t != 'object' || Array.isArray(t)) throw new _(`Invalid value ${JSON.stringify(t)} for "datasources" provided to PrismaClient constructor`)
                for (let [r, n] of Object.entries(t)) {
                    if (!e.includes(r)) {
...
It should have this form: { url: "CONNECTION_STRING" }`)
        ...
        adapter: (t, e) => {
            if (!t && Ue(e.generator) === 'client') throw new _('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.')
            if (t === null) return
            if (t === void 0) throw new _('"adapter" property must not be undefined, use null to conditionally disable driver adapters.')
            if (!dr(e).includes('driverAdapters')) throw new _('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.')
            if (Ue(e.generator) === 'binary') throw new _('Cannot use a driver adapter with the "binary" Query Engine. Please use the "library" Query Engine.')
        },
        datasourceUrl: (t) => {
...
Expected string or undefined.`)
        ...
        transactionOptions: (t) => {
            if (!t) return
            let e = t.maxWait
            if (e != null && e <= 0) throw new _(`Invalid value ${e} for maxWait in "transactionOptions" provided to PrismaClient constructor. maxWait needs to be greater than 0`)
            let r = t.timeout
...
function Wo(t) {
    class e {
        ...
        constructor(n) {
            ...
            let o = t.relativeEnvPaths && { rootEnvPath: t.relativeEnvPaths.rootEnvPath && Nt.resolve(t.dirname, t.relativeEnvPaths.rootEnvPath), schemaEnvPath: t.relativeEnvPaths.schemaEnvPath && Nt.resolve(t.dirname, t.relativeEnvPaths.schemaEnvPath) },
                s
            if (n?.adapter) {
                s = n.adapter
            ...
            try {
                ...
                if (
                    ...
                    (this._accelerateEngineConfig = { ...this._engineConfig, accelerateUtils: { resolveDatasourceUrl: cr, getBatchRequestPayload: sr, prismaGraphQLToJSError: ar, PrismaClientUnknownRequestError: j, PrismaClientInitializationError: I, PrismaClientKnownRequestError: X, debug: J('prisma:client:accelerateEngine'), engineVersion: Go.version, clientVersion: t.clientVersion } }),
        ...
        _createItxClient(n) {
            return ae(Tt(ae(Yi(this), [K('_appliedParent', () => this._appliedParent._createItxClient(n)), K('_createPrismaPromise', () => sn(n)), K($l, () => n.id)])), [Xe(ro)])
        }
        $transaction(n, i) {
            let o
            typeof n == 'function'
        ...
        _request(n) {
            ...
            let i = n.middlewareArgsMapper ?? Bl,
                ...
                f = async (h) => {
                    ...
                    return O.model ? to({ result: S, modelName: O.model, args: O.args, extensions: this._extensions, runtimeDataModel: this._runtimeDataModel, globalOmit: this._globalOmit }) : S
                }
        ...
        async _executeRequest({ args: n, clientMethod: i, dataPath: o, callsite: s, action: a, model: f, argsMapper: h, transaction: T, unpacker: C, otelParentCtx: k, customDataProxyFetch: A }) {
            try {
                ...
                let O = { name: 'serialize' },
                    S = this._tracingHelper.runInChildSpan(O, () => er({ modelName: f, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }))
                return (
...
`
                    ...
                    this._requestHandler.request({ protocolQuery: S, modelName: f, action: a, clientMethod: i, dataPath: o, callsite: s, args: n, extensions: this._extensions, transaction: T, unpacker: C, otelParentCtx: k, otelChildCtx: this._tracingHelper.getActiveContext(), globalOmit: this._globalOmit, customDataProxyFetch: A })
                )
            } catch (O) {
