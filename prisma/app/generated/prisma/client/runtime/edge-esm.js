...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    ma = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function') for (let i of ua(t)) !pa.call(e, i) && i !== r && en(e, i, { get: () => t[i], enumerable: !(n = la(t, i)) || n.enumerable })
        return e
    }
...
var Ei = Fe((Ke) => {
        ...
        da = oi((e) => {
            ...
            function g(A) {
                var R,
                    ...
                    ie = B > 0 ? M - 4 : M,
                    G
                for (G = 0; G < ie; G += 4) (R = (r[A.charCodeAt(G)] << 18) | (r[A.charCodeAt(G + 1)] << 12) | (r[A.charCodeAt(G + 2)] << 6) | r[A.charCodeAt(G + 3)]), (k[F++] = (R >> 16) & 255), (k[F++] = (R >> 8) & 255), (k[F++] = R & 255)
                return B === 2 && ((R = (r[A.charCodeAt(G)] << 2) | (r[A.charCodeAt(G + 1)] >> 4)), (k[F++] = R & 255)), B === 1 && ((R = (r[A.charCodeAt(G)] << 10) | (r[A.charCodeAt(G + 1)] << 4) | (r[A.charCodeAt(G + 2)] >> 2)), (k[F++] = (R >> 8) & 255), (k[F++] = R & 255)), k
            }
            function h(A) {
                return t[(A >> 18) & 63] + t[(A >> 12) & 63] + t[(A >> 6) & 63] + t[A & 63]
            }
            function v(A, R, D) {
                for (var M, B = [], k = R; k < D; k += 3) (M = ((A[k] << 16) & 16711680) + ((A[k + 1] << 8) & 65280) + (A[k + 2] & 255)), B.push(h(M))
                return B.join('')
            }
            function S(A) {
    ...
    function si(e, t, r) {
        ...
        if (de(e, ArrayBuffer) || (e && de(e.buffer, ArrayBuffer)) || (typeof SharedArrayBuffer < 'u' && (de(e, SharedArrayBuffer) || (e && de(e.buffer, SharedArrayBuffer))))) return li(e, t, r)
    ...
    function ci(e, t, r, n, i) {
        ...
        if (typeof t == 'number') return (t = t & 255), typeof Uint8Array.prototype.indexOf == 'function' ? (i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r)) : ri(e, [t], r, n, i)
    ...
    an(
        ...
        function (e, t, r) {
            let n = `The value of "${e}" is out of range.`,
                i = r
            return Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? (i = ii(String(r))) : typeof r == 'bigint' && ((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = ii(i)), (i += 'n')), (n += ` It must be ${t}. Received ${i}`), n
        },
        RangeError
    )
    function ii(e) {
...
var Pn = Fe((Dy, Eo) => {
    ...
    Eo.exports = (function () {
        ...
        return function (t, r) {
            ...
            for (var ie = F.length - 1; a < o - 3; ) for (D = r.charCodeAt(s + (f = a)), M = r.charCodeAt(s + (g = a + 1)), B = r.charCodeAt(s + (h = a + 2)), k = r.charCodeAt(s + (v = a + 3)), S = a += 4, l = 0; l < ie; l += 2) (A = F[l]), (R = F[l + 1]), (f = e(A, f, g, D, R)), (g = e(f, g, h, M, R)), (h = e(g, h, v, B, R)), (S = e(h, v, S, k, R)), (F[l] = S), (v = h), (h = g), (g = f), (f = A)
            for (; a < o; ) for (D = r.charCodeAt(s + (f = a)), S = ++a, l = 0; l < ie; l += 2) (A = F[l]), (F[l] = S = e(A, f, S, D, F[l + 1])), (f = A)
            return S
        }
    })()
})
...
C.cosine = C.cos = function () {
    var e,
        ...
        r = this,
        n = r.constructor
    return r.d ? (r.d[0] ? ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = vl(n, ho(n, r))), (n.precision = e), (n.rounding = t), I(Pe == 2 || Pe == 3 ? r.neg() : r, e, t, !0)) : new n(1)) : new n(NaN)
}
C.cubeRoot = C.cbrt = function () {
    ...
    for (_ = !1, o = g.s * J(g.s * g, 1 / 3), !o || Math.abs(o) == 1 / 0 ? ((r = K(g.d)), (e = g.e), (o = (e - r.length + 1) % 3) && (r += o == 1 || o == -2 ? '0' : '00'), (o = J(r, 1 / 3)), (e = Z((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2))), o == 1 / 0 ? (r = '5e' + e) : ((r = o.toExponential()), (r = r.slice(0, r.indexOf('e') + 1) + e)), (n = new h(r)), (n.s = g.s)) : (n = new h(o.toString())), s = (e = h.precision) + 3; ; )
...
C.hyperbolicCosine = C.cosh = function () {
    ...
    ;(r = s.precision), (n = s.rounding), (s.precision = r + Math.max(o.e, o.sd()) + 4), (s.rounding = 1), (i = o.d.length), i < 32 ? ((e = Math.ceil(i / 3)), (t = (1 / br(4, e)).toString())) : ((e = 16), (t = '2.3283064365386962890625e-10')), (o = et(s, 1, o.times(t), new s(1), !0))
...
C.inverseHyperbolicTangent = C.atanh = function () {
    var e,
        ...
        i = this,
        o = i.constructor
    return i.isFinite() ? (i.e >= 0 ? new o(i.abs().eq(1) ? i.s / 0 : i.isZero() ? i : NaN) : ((e = o.precision), (t = o.rounding), (n = i.sd()), Math.max(n, e) < 2 * -i.e - 1 ? I(new o(i), e, t, !0) : ((o.precision = r = n - i.e), (i = q(i.plus(1), new o(1).minus(i), r + e, 1)), (o.precision = e + 4), (o.rounding = 1), (i = i.ln()), (o.precision = e), (o.rounding = t), i.times(0.5)))) : new o(NaN)
}
...
C.sine = C.sin = function () {
    var e,
        ...
        r = this,
        n = r.constructor
    return r.isFinite() ? (r.isZero() ? new n(r) : ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = Cl(n, ho(n, r))), (n.precision = e), (n.rounding = t), I(Pe > 2 ? r.neg() : r, e, t, !0))) : new n(NaN)
}
C.squareRoot = C.sqrt = function () {
    ...
    for (_ = !1, f = Math.sqrt(+s), f == 0 || f == 1 / 0 ? ((t = K(a)), (t.length + l) % 2 == 0 && (t += '0'), (f = Math.sqrt(t)), (l = Z((l + 1) / 2) - (l < 0 || l % 2)), f == 1 / 0 ? (t = '5e' + l) : ((t = f.toExponential()), (t = t.slice(0, t.indexOf('e') + 1) + l)), (n = new g(t))) : (n = new g(f.toString())), r = (l = g.precision) + 3; ; )
...
C.toFraction = function (e) {
    var t,
        ...
        R = S.constructor
    if (!A) return new R(S)
    if (((f = r = new R(1)), (n = l = new R(0)), (t = new R(n)), (o = t.e = po(A) - S.e - 1), (s = o % O), (t.d[0] = J(10, s < 0 ? O + s : s)), e == null)) e = o > 0 ? t : f
    else {
        if (((a = new R(e)), !a.isInt() || a.lt(f))) throw Error(Ie + a)
        e = a.gt(t) ? (o > 0 ? t : f) : a
    }
    for (_ = !1, a = new R(K(A)), g = R.precision, R.precision = o = A.length * O * 2; (h = q(a, t, 0, 1, 1)), (i = r.plus(h.times(n))), i.cmp(e) != 1; ) (r = n), (n = i), (i = f), (f = l.plus(h.times(i))), (l = i), (i = t), (t = a.minus(h.times(i))), (a = i)
    return (
...
C.toPower = C.pow = function (e) {
    ...
    return (
        ...
        t > l.maxE + 1 || t < l.minE - 1 ? new l(t > 0 ? s / 0 : 0) : ((_ = !1), (l.rounding = a.s = 1), (r = Math.min(12, (t + '').length)), (i = En(e.times(ke(a, n + r)), n)), i.d && ((i = I(i, n + 5, 1)), Tt(i.d, n, o) && ((t = n + 10), (i = I(En(e.times(ke(a, t + r)), t), t + 5, 1)), +K(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))), (i.s = s), (_ = !0), (l.rounding = o), I(i, n, o))
    )
}
...
function dr(e, t, r) {
    for (var n, i = [0], o, s = 0, a = e.length; s < a; ) {
        ...
        for (i[0] += hn.indexOf(e.charAt(s++)), n = 0; n < i.length; n++) i[n] > r - 1 && (i[n + 1] === void 0 && (i[n + 1] = 0), (i[n + 1] += (i[n] / r) | 0), (i[n] %= r))
    }
    return i.reverse()
}
function vl(e, t) {
    ...
    ;(n = t.d.length), n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / br(4, r)).toString())) : ((r = 16), (i = '2.3283064365386962890625e-10')), (e.precision += r), (t = et(e, 1, t.times(i), new e(1)))
    for (var o = r; o--; ) {
        var s = t.times(t)
...
var q = (function () {
    ...
    return function (n, i, o, s, a, l) {
        ...
        for (l ? ((S = 1), (g = n.e - i.e)) : ((l = ce), (S = O), (g = Z(n.e / S) - Z(i.e / S))), ue = $.length, Et = z.length, M = new nr(Xr), B = M.d = [], h = 0; $[h] == (z[h] || 0); h++);
        if (($[h] > (z[h] || 0) && g--, o == null ? ((G = o = nr.precision), (s = nr.rounding)) : a ? (G = o + (n.e - i.e) + 1) : (G = o), G < 0)) B.push(1), (A = !0)
        else {
            if (((G = (G / S + 2) | 0), (h = 0), ue == 1)) {
                for (v = 0, $ = $[0], G++; (h < Et || v) && G--; h++) (Yr = v * l + (z[h] || 0)), (B[h] = (Yr / $) | 0), (v = Yr % $ | 0)
                A = v || h < Et
            } else {
                for (v = (l / ($[0] + 1)) | 0, v > 1 && (($ = e($, v, l)), (z = e(z, v, l)), (ue = $.length), (Et = z.length)), tr = ue, k = z.slice(0, ue), F = k.length; F < ue; ) k[F++] = 0
                ;(rr = $.slice()), rr.unshift(0), (Zr = $[0]), $[1] >= l / 2 && ++Zr
                do
                    (v = 0),
                        (f = t($, k, ue, F)),
                        f < 0 ? ((ie = k[0]), ue != F && (ie = ie * l + (k[1] || 0)), (v = (ie / Zr) | 0), v > 1 ? (v >= l && (v = l - 1), (R = e($, v, l)), (D = R.length), (F = k.length), (f = t(R, k, D, F)), f == 1 && (v--, r(R, ue < D ? rr : $, D, l))) : (v == 0 && (f = v = 1), (R = $.slice())), (D = R.length), D < F && R.unshift(0), r(k, R, F, l), f == -1 && ((F = k.length), (f = t($, k, ue, F)), f < 1 && (v++, r(k, ue < F ? rr : $, F, l))), (F = k.length)) : f === 0 && (v++, (k = [0])),
                        (B[h++] = v),
...
function ke(e, t) {
    ...
    } else return (f = yr(M, g + 2, k).times(o + '')), (R = ke(new M(n + '.' + r.slice(1)), g - A).plus(f)), (M.precision = k), t == null ? I(R, k, B, (_ = !0)) : R
    for (h = R, l = s = R = q(R.minus(1), R.plus(1), g, 1), v = I(R.times(R), g, 1), i = 3; ; ) {
        if (((s = I(s.times(v), g, 1)), (f = l.plus(q(s, new M(i), g, 1))), K(f.d).slice(0, g) === K(l.d).slice(0, g)))
            if (((l = l.times(2)), o !== 0 && (l = l.plus(yr(M, g + 2, k).times(o + ''))), (l = q(l, new M(S), g, 1)), t == null))
                if (Tt(l.d, g - A, B, a)) (M.precision = g += A), (f = s = R = q(h.minus(1), h.plus(1), g, 1)), (v = I(R.times(R), g, 1)), (i = a = 1)
...
function Tl(e, t) {
    ...
    for (o = t.search(/p/i), o > 0 ? ((l = +t.slice(o + 1)), (t = t.substring(2, o))) : (t = t.slice(2)), o = t.indexOf('.'), s = o >= 0, n = e.constructor, s && ((t = t.replace('.', '')), (a = t.length), (o = a - o), (i = mo(n, new n(r), o, o * 2))), f = dr(t, r, ce), g = f.length - 1, o = g; f[o] === 0; --o) f.pop()
    return o < 0 ? new n(e.s * 0) : ((e.e = Er(f, g)), (e.d = f), (_ = !1), s && (e = q(e, i, a * 4)), l && (e = e.times(Math.abs(l) < 54 ? J(2, l) : Be.pow(2, l))), (_ = !0), e)
}
function Cl(e, t) {
    var r,
        n = t.d.length
...
function bn(e, t, r, n) {
    ...
    if ((A ? (re(r, 1, Oe), n === void 0 ? (n = S.rounding) : re(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite())) g = go(e)
        ...
        for (g = ge(e), s = g.indexOf('.'), A ? ((i = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (i = t), s >= 0 && ((g = g.replace('.', '')), (v = new S(1)), (v.e = g.length - s), (v.d = dr(ge(v), 10, i)), (v.e = v.d.length)), h = dr(g, 10, i), o = l = h.length; h[--l] == 0; ) h.pop()
        if (!h[0]) g = A ? '0p+0' : '0'
        else {
            ...
            : !e.d && !t.d
              ...
              : !t.d || e.isZero()
                ...
                : !e.d || t.isZero()
                  ...
                  : t.s < 0
                    ? ((this.precision = o), (this.rounding = 1), (r = this.atan(q(e, t, o, 1))), (t = fe(this, o, 1)), (this.precision = n), (this.rounding = i), (r = e.s < 0 ? r.minus(t) : r.plus(t)))
...
function yo(e) {
    ...
    function i(o) {
        ...
        if (l === 'string') return (a = o.charCodeAt(0)) === 45 ? ((o = o.slice(1)), (f.s = -1)) : (a === 43 && (o = o.slice(1)), (f.s = 1)), co.test(o) ? fr(f, o) : Tl(f, o)
...
function Lo(e, t, r) {
    let n = we(r)
    return !t.result || !(t.result.$allModels || t.result[n]) ? e : Ju({ ...e, ...Fo(t.name, e, t.result.$allModels), ...Fo(t.name, e, t.result[n]) })
}
function Ju(e) {
    let t = new he(),
...
function In({ modelName: e, action: t, args: r, runtimeDataModel: n, extensions: i = ut.empty(), callsite: o, clientMethod: s, errorFormat: a, clientVersion: l, previewFeatures: f, globalOmit: g }) {
    let h = new kn({ runtimeDataModel: n, modelName: e, action: t, rootArgs: r, callsite: o, extensions: i, selectionPath: [], argumentPath: [], originalMethod: s, errorFormat: a, clientVersion: l, previewFeatures: f, globalOmit: g })
...
function zu(e, t, r, n) {
    return e ? (t ? n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'include', secondField: 'select', selectionPath: n.getSelectionPath() }) : r && n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'omit', secondField: 'select', selectionPath: n.getSelectionPath() }), ec(e, n)) : Yu(n, t, r)
}
function Yu(e, t, r) {
    let n = {}
...
function $r({ error: e, user_facing_error: t }, r, n) {
    return t.error_code ? new oe(mc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx }) : new se(e, { clientVersion: r, batchRequestIdx: t.batch_request_idx })
}
function mc(e, t) {
    let r = e.message
    return (
    ...
    ht = class {
        ...
        async start() {
            this.startPromise !== void 0 && (await this.startPromise),
                (this.startPromise = (async () => {
                    ...
                    ;(this.host = t), (this.headerBuilder = new Wn({ apiKey: r, tracingHelper: this.tracingHelper, logLevel: this.config.logLevel, logQueries: this.config.logQueries, engineHash: this.engineHash })), (this.remoteClientVersion = await Is(t, this.config)), Qr('host', this.host)
                })()),
        ...
        extractHostAndApiKey() {
            let t = { clientVersion: this.clientVersion },
                ...
                n = mt({ inlineDatasources: this.inlineDatasources, overrideDatasources: this.config.overrideDatasources, clientVersion: this.clientVersion, env: this.env }),
                i
            try {
                i = new URL(n)
            } catch {
            ...
            if (o !== 'prisma:' && o !== pr) throw new qe(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\``, t)
            let l = a.get('api_key')
        ...
        convertProtocolErrorsToClientError(t) {
            return t.length === 1 ? $r(t[0], this.config.clientVersion, this.config.activeProvider) : new se(JSON.stringify(t), { clientVersion: this.config.clientVersion })
        }
            ...
            ;(this.logEmitter = r),
                ...
                (this.dataloader = new Kr({
                    batchLoader: ws(async ({ requests: n, customDataProxyFetch: i }) => {
                        ...
                        return (await this.client._engine.requestBatch(a, { traceparent: l, transaction: np(o), containsWrite: f, customDataProxyFetch: i })).map((h, v) => {
                    ...
                    singleLoader: async (n) => {
                        let i = n.transaction?.kind === 'itx' ? Hs(n.transaction) : void 0,
                            o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Xn(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch })
...
It should have this form: { url: "CONNECTION_STRING" }`)
        ...
        adapter: (e, t) => {
            ...
            if (!Jr(t).includes('driverAdapters')) throw new U('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.')
...
function fp(e) {
    class t {
        ...
        constructor(n) {
            ...
            let o = e.relativeEnvPaths && { rootEnvPath: e.relativeEnvPaths.rootEnvPath && cr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && cr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
                s
            if (n?.adapter) {
                s = n.adapter
        ...
        $executeRawInternal(n, i, o, s) {
            ...
            return this._request({ action: 'executeRaw', args: o, transaction: n, clientMethod: i, argsMapper: Kn({ clientMethod: i, activeProvider: a }), callsite: _e(this._errorFormat), dataPath: [], middlewareArgsMapper: s })
        }
        $executeRaw(n, ...i) {
        ...
        $executeRawUnsafe(n, ...i) {
            return this._createPrismaPromise((o) => (Hn(this._activeProvider, n, i, 'prisma.$executeRawUnsafe(<SQL>, [...values])'), this.$executeRawInternal(o, '$executeRawUnsafe', [n, ...i])))
        }
        $runCommandRaw(n) {
            ...
            return this._createPrismaPromise((i) => this._request({ args: n, clientMethod: '$runCommandRaw', dataPath: [], action: 'runCommandRaw', argsMapper: Ms, callsite: _e(this._errorFormat), transaction: i }))
        }
        async $queryRawInternal(n, i, o, s) {
            let a = this._activeProvider
            return this._request({ action: 'queryRaw', args: o, transaction: n, clientMethod: i, argsMapper: Kn({ clientMethod: i, activeProvider: a }), callsite: _e(this._errorFormat), dataPath: [], middlewareArgsMapper: s })
        }
        $queryRaw(n, ...i) {
            return this._createPrismaPromise((o) => {
        ...
        _createItxClient(n) {
            return pe($t(pe(ls(this), [ee('_appliedParent', () => this._appliedParent._createItxClient(n)), ee('_createPrismaPromise', () => zn(n)), ee(mp, () => n.id)])), [ct(ds)])
        }
        $transaction(n, i) {
            let o
            typeof n == 'function'
        ...
        _request(n) {
            ...
            let i = n.middlewareArgsMapper ?? pp,
                ...
                l = async (f) => {
                    ...
                    return A.model ? ms({ result: R, modelName: A.model, args: A.args, extensions: this._extensions, runtimeDataModel: this._runtimeDataModel, globalOmit: this._globalOmit }) : R
                }
        ...
        async _executeRequest({ args: n, clientMethod: i, dataPath: o, callsite: s, action: a, model: l, argsMapper: f, transaction: g, unpacker: h, otelParentCtx: v, customDataProxyFetch: S }) {
            try {
                ...
                let A = { name: 'serialize' },
                    R = this._tracingHelper.runInChildSpan(A, () => In({ modelName: l, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }))
                return (
...
`
                    ...
                    this._requestHandler.request({ protocolQuery: R, modelName: l, action: a, clientMethod: i, dataPath: o, callsite: s, args: n, extensions: this._extensions, transaction: g, unpacker: h, otelParentCtx: v, otelChildCtx: this._tracingHelper.getActiveContext(), globalOmit: this._globalOmit, customDataProxyFetch: S })
                )
            } catch (A) {
